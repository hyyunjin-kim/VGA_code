...
module Image_rom (
    ...
    assign {red_port, green_port, blue_port} = (DE && x_pixel < 320 && y_pixel <240) ? {image_data[15:12]&sw_red[3:0],image_data[10:7]&sw_green[3:0],image_data[4:1]&sw_blue[3:0]} : 12'b0; 
